...
export const deleteReviews = (id, productId) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.delete(
      `/api/v1/reviews?id=${id}&productId=${productId}?token=${token}`,
      config
    );
...
export const getAllProductAdmin = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(
      `/api/v1/admin/products?token=${token}`,
      config
    );
...
export const newProduct = (product) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.post(
      `/api/v1/admin/product/new?token=${token}`,
      product,
      config
    );
...
export const deleteProduct = (id) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.delete(
      `/api/v1/admin/product/${id}?token=${token}`,
      config
    );
