    ...
    return (
        <>
            <Link
                ...
                className=" text-[rgb(48,48,48)]  flex flex-col transition-all shadow-md duration-200 pb-3 rounded-lg  w-[20rem]  h-[28rem] flex-wrap  justify-between relative border hover:bg-gray-200 hover:border-2 hover:border-gray-300 group"
            >
                <div>
